...
.m-page{width:100%;max-width:480px;margin-inline:auto;padding:calc(16px + var(--m-safe-top)) calc(var(--m-pad) + var(--m-safe-right)) calc(var(--m-nav-height) + var(--m-safe-bottom) + 8px) calc(var(--m-pad) + var(--m-safe-left))}
