...
export async function GET(req: NextRequest) {
  ...
  // Временная диагностика — почему-то у некоторых пользователей карта
  // всё равно показывает Тюмень, хотя в профиле стоит другой город.
  // Смотрим в логах Vercel, что реально приходит на этом этапе.
  console.log("DEBUG /api/events/map:", {
    cityFromQuery: searchParams.get("city"),
