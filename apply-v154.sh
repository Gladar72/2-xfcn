...
export default function EventDetailsPage({ params }: EventDetailsPageProps) {
  ...
  return (
    <div className="pb-28">
      ...
      {/* "Отменить встречу" — закреплена внизу экрана всегда (не уезжает
          при прокрутке), как и остальные закреплённые кнопки в этом же
          месте для других ролей — по явному запросу пользователя. */}
