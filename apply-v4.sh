...
const inputClass =
  "w-full rounded-card border border-lavender-200 bg-white px-5 py-4 text-lg text-ink-900 outline-none focus:border-accent";
        ...
        {step === "where" && (
          <StepBlock title="Где?" subtitle="Впиши название места и отметь его на карте.">
            ...
            <input
              ...
              className={`mb-3 text-base ${inputClass}`}
            />
...
cat > "components/ui/StepProgress.tsx" << 'ENDOFFILE'
